...
#include "../include/rmmmimplementation.h"
...
static inline unsigned int RMLEBufToUint32(const RMuint8 *buf) {
...
inline unsigned int RMMemcmp(const void *buffer1, const void *buffer2, unsigned int size)
{
	return memcmp(buffer1, buffer2, size);
}

inline void *RMCalloc(uint32 elements, RMuint32 elementSize)
{
