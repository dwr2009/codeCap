...
extern DMD_ERROR_t	DMD_device_set_TCB_mode( DMD_PARAMETER_t* param); //troy.wangyx, 20120801 
extern DMD_ERROR_t   DMD_device_set_echo_enhance(DMD_PARAMETER_t* param, DMD_ECHO_PERFORMANCE_SET echo_out );//troy.wangyx, 20120801 
extern DMD_ERROR_t   DMD_device_cochan_interface_detect( DMD_PARAMETER_t *param );//troy.wangyx, 20120801 
