...
extern DMD_ERROR_t DMD_API DMD_set_system	( DMD_PARAMETER_t* param,PMXL603_TUNER_MODE_CFG_T pCfgTunerParam);
extern DMD_ERROR_t DMD_API DMD_tune			( DMD_PARAMETER_t* param);
extern DMD_ERROR_t DMD_API DMD_scan			( DMD_PARAMETER_t* param ,PMXL603_CHAN_TUNE_CFG_T pChannelInfo);
...
extern DMD_ERROR_t DMD_API DMD_get_SSI( DMD_PARAMETER_t *param, unsigned short *pdata);
