...
#define MXL603_I2C_ADDR 0x60//(0x60<<1)
...
MXL_STATUS MxLWare603_API_CfgTunerMode(UINT8 devId, PMXL603_TUNER_MODE_CFG_T ptunerModeCfg);
...
MXL_STATUS MxLWare603_API_CfgTunerChanTune(UINT8 devId, PMXL603_CHAN_TUNE_CFG_T pChanTuneCfg);
...
extern MXL_STATUS Mxl603SetSystemMode(PMXL603_TUNER_MODE_CFG_T pTunerModeCfg);
extern MXL_STATUS Mxl603SetFreqBw(PMXL603_CHAN_TUNE_CFG_T pChannelInfoCfg);
