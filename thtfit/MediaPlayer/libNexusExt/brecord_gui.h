 ...
 *
 *****************************************************************************/
#ifndef B_RECORD_GUI_H__
#define B_RECORD_GUI_H__
...
struct brecord_gui_settings
{
    ...
    const char *destName;
    NEXUS_Pixel color;
    NEXUS_Pixel borderColor;
    const char *fontname;

    unsigned zorder;
    NEXUS_Rect rect; /* if default, will position based on recpump index */
    NEXUS_SurfaceRegion virtualDisplay;
};

typedef struct brecord_gui *brecord_gui_t;
